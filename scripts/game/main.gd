...
var water_drop_scene = preload("res://scenes/game/components/WaterDrop.tscn")
var carousel = preload("res://scenes/game/components/carousel.tscn").instantiate()
var carousel2 = preload("res://scenes/game/components/carousel.tscn").instantiate()
...
var polluted_background = load("res://assets/backgrounds/game/industry_bg_8.jpg")
var natural_background = load("res://assets/backgrounds/game/nature_bg_3.png")
...
func setup_audio():
	...
	add_child(win_sound)
	var sound = load("res://assets/audio/sfx/game_win.wav")
	if sound:
	...
	var combo_sound_resource = load("res://assets/audio/sfx/Impact Tom 001.wav")  # Make sure to create this audio file
	...
	for i in range(num_rocks):
		...
		while attempts < 100:  # Limit attempts to prevent infinite loop
			...
			if is_cell_empty(grid_x, grid_y):
				var rock = preload("res://scenes/game/components/Rock.tscn").instantiate()
...
func create_vertical_rocks():
	...
	for i in range(num_vertical_rocks):
		...
		while attempts < 100:  # Limit attempts to prevent infinite loop
			...
			var grid_y = randi() % (grid_height - top_margin - 2) + top_margin + 1
			if is_cell_empty(grid_x, grid_y):
				var vertical_rock = preload("res://scenes/game/components/VerticalRock.tscn").instantiate()
...
func create_seed_pegs():
	...
	for i in range(num_seeds):
		...
		while attempts < 100:  # Limit attempts to prevent infinite loop
			...
			var grid_y = randi() % (grid_height - top_margin - 2) + top_margin + 1
			if is_cell_empty(grid_x, grid_y):
				var seed_peg = preload("res://scenes/game/components/Seed.tscn").instantiate()
...
func win_game():
	...
	#var win_banner = preload("res://scenes/ui/WinBanner.tscn").instantiate()
	#win_banner.position = Vector2(1920/2, 1080/2)
	#add_child(win_banner)

func create_arrow():
	var arrow = preload("res://scenes/game/components/Arrow.tscn").instantiate()
...
func create_crossbow():
	...
	crossbow.texture = load("res://assets/sprites/crossbow.png")  # Make sure to create this image
